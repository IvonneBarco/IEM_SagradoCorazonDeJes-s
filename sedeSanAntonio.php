			...
			<section class="posts col-md-9">				
				<div class="migas-de-pan"> <!--Inicia migas de pan-->				
					<ol class="breadcrumb" id="miga">
						...
						<li><a href="index.php">Sede San Antonio</a></li>
					</ol>
					 ...
					 ?>
						<article class="post clearfix">
							...
							<table>
								...
								<tr>
									<?php echo "<td><center><br>".'<img src="./admin/uploads/'.$fila["imagen"].'" class="img-thumbnail img-rounded img-border-green img-responsive animated zoomIn retraso2" style="width: 40%; height: 20%;">'."<center></td>"; ?>
								</tr>
							</table>                         
