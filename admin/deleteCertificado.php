...
<title>.:: Eliminar Certificados</title>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    <!-- Inicia Head -->
            ...
            <section class="posts col-md-9">  
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Eliminar Certificados</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">ELIMINACIÓN DE CERTIFICADOS</h1>
                        <hr class="line-1">
                        ...
                        <br>
                            <?php
                                ...
                                $sql = "DELETE FROM certificado WHERE codcertificado='$codcertificado'";
                                $res = mysqli_query($bd, $sql);

                                if($res){?>
                                    <center>
                                        <img src="../images/imgCert-delete.png" class="img-responsive img-icono" alt="Img-Estudiante-Eliminado">                                 
                                    </center> 
                            ...
                            ?>
                            <h3 align="center"><a href="editarCertificados.php" class="royalPurple">Regresar</a></h3>
                    </div>
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
            </section>
