...
<title>.:: Guardar Sede Bohorques</title>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    <!-- Inicia Head -->
            ...
            <section class="posts col-md-9">  
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Guardar Sede Bohorques</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">SEDE BOHORQUES</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            ...
                            <?php                             
                                ...
                                $sql0 = "DELETE FROM sedebohorques WHERE seccion='".$seccion."'";
                                $sql = "INSERT INTO sedebohorques VALUES('$titulo','$texto','$seccion','$foto')";
                                ...
                                if($resultado){
                                    ...
                                    <br><h3><a href="adminSedeB.php" class="royalPurple">Regresar</a></h3>
                                <?php
                                }
                                else{
                                    ...
                                    <br><h3><a href="adminSedeB.php" class="royalPurple"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></h3> <?php
                                }
                                mysqli_close($bd);
                            ?> 
                        <!-- acción del formuluario -->                               
