            ...
            <section class="posts col-md-9">  
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Eliminar Contacto</a></li>
                    </ol>
                    ...
                    <div class="main-container">
                        ...
                        <br>
                            <?php
                                ...
                                $sql = "DELETE FROM contactos WHERE idcontactos='$idcontactos'";
                                $res = mysqli_query($bd, $sql);

                                if($res){?>
                                    <center>
                                        <img src="../images/imgContact-delete.png" class="img-responsive img-icono" alt="Img-Contacto-Eliminado">                                 
                                    </center> 
