            ...
            <section class="posts col-md-9">
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Consultar Estudiantes</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadowRoyalPurple">CONSULTA DE ESTUDIANTES</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            <img src="../images/5.2.png" class="img-responsive img-icono" alt="Img-Student">                                   
                                <table>
                                    <tr>
                                        <td>
                                            <div class="alert alert-info">
                                                Por favor ingrese documento del estudiante
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <form action="buscarEstudiante.php" method="POST" class="input-group input-group-lg">
