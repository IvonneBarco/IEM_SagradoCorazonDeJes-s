...
<title>.:: Guardar Sede Alto Ingenio</title>
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    <!-- Inicia Head -->
            ...
            <section class="posts col-md-9">  
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Guardar Sede Alto Ingenio</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">SEDE ALTO INGENIO</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            ...
                            <?php                             
                                ...
                                $sql0 = "DELETE FROM sedealto WHERE seccion='".$seccion."'";
                                $sql = "INSERT INTO sedealto VALUES('$titulo','$texto','$seccion','$foto')";
                                ...
                                if($resultado){
                                    ...
                                    <br><h3><a href="adminSedeA.php" class="royalPurple">Regresar</a></h3>
                                <?php
                                }
                                else{
                                    ...
                                    <br><h3><a href="adminSedeA.php" class="royalPurple"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></h3> <?php
                                }
                                mysqli_close($bd);
                            ?> 
                        <!-- acción del formuluario -->                               
