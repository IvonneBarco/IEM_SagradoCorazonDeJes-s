            ...
            <section class="posts col-md-9">
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Consultar Certificados</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadowRoyalPurple">CONSULTA DE CERTIFICADOS</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            <img src="../images/5.4.png" class="img-responsive img-icono" alt="Img-Certificado">                                   
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <form action="buscarCertificado.php" method="POST" class="input-group input-group-lg">
