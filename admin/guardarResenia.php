            ...
            <section class="posts col-md-9">  
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">RESEÑA</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            ...
                            <?php                             
                                ...
                                $sql0 = "DELETE FROM pagresena WHERE seccion='".$seccion."'";
                                $sql = "INSERT INTO pagresena VALUES('$titulo','$texto','$seccion','$foto')";
                                ...
                                if($resultado){
                                    ...
                                    <table style="width:45%">
                                        ...
                                        <tr>
                                            <th class="brickRed"><br>TEXTO RESEÑA: </th>
                                        </tr>
                                        <tr>
                                    ...
                                    <br><h3><a href="adminResenia.php" class="royalPurple">Regresar</a></h3>
                                <?php
                                }
                                else{
                                    ...
                                    <br><h3><a href="adminResenia.php" class="royalPurple"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></h3> <?php
                                }
                                mysqli_close($bd);
                            ?> 
                        <!-- acción del formuluario -->                               
