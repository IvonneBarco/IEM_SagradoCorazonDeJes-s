            ...
            <section class="posts col-md-9">  
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Guardar Valores</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">VALORES</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            ...
                            <?php                             
                                ...
                                $sql0 = "DELETE FROM pagvalores WHERE seccion='".$seccion."'";
                                $sql = "INSERT INTO pagvalores VALUES('$titulo','$texto','$seccion','$foto')";
                                ...
                                if($resultado){
                                    ...
                                    <table style="width:45%">
                                        ...
                                        <tr>
                                            <th class="brickRed"><br>TEXTO VALORES: </th>
                                        </tr>
                                        <tr>
                                    ...
                                    <br><h3><a href="adminValores.php" class="royalPurple">Regresar</a></h3>
                                <?php
                                }
                                else{
                                    ...
                                    <br><h3><a href="adminValores.php" class="royalPurple"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></h3> <?php
                                }
                                mysqli_close($bd);
                            ?> 
                        <!-- acción del formuluario -->                               
