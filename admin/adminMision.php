            ...
            <section class="posts col-md-9">
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Página Misión</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">PÁGINA MISIÓN</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            ...
                            <form  class="form-group" action="guardarMision.php" id="contact_form" method="POST" enctype="multipart/form-data">                            
                                <table>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="file" class="form-control size-font-form" name="imagen" id="imagen"><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
