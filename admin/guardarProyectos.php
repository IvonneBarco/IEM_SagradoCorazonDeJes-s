            ...
            <section class="posts col-md-9">  
                ...
                <div class="migas-de-pan"> <!--Inicia migas de pan-->               
                    <ol class="breadcrumb" id="miga">
                        ...
                        <li class=""><a href="#">Guardar Proyectos</a></li>
                    </ol>
                ...
                <!-- /*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/*/-->
                    ...
                    <div class="main-container">
                        ...
                        <br><br>
                        <h1 class="text-center brickRed shadow-brickRed">PROYECTOS</h1>
                        <hr class="line-1">
                        ...
                        <center>
                            ...
                            <?php                             
                                ...
                                $sql0 = "DELETE FROM proyectos WHERE seccion='".$seccion."'";
                                $sql = "INSERT INTO proyectos VALUES('$titulo','$texto','$seccion','$foto','$archivo')";
                                ...
                                if($resultado){
                                    ...
                                    <table style="width:45%">
                                        ...
                                        move_uploaded_file($ruta, "./uploads/$nomFile");?>
                                    </table>
                                    <br><h3><a href="adminProyectos.php" class="royalPurple">Regresar</a></h3>
                                <?php
                                }
                                else{
                                    ...
                                    <br><h3><a href="adminProyectos.php" class="royalPurple"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></h3> <?php
                                }
                                mysqli_close($bd);
                            ?> 
                        <!-- acción del formuluario -->                               
